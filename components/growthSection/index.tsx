    ...
    <>
      <div className={styles.growthContain}>
        <div className={styles.growthText}>
          ...
          <p>
            BloomByte hub has a vision to shape the future of the tech space from Akure, Ondo state to the utmost part of Nigeria and Africa. We are on a mission, to see every
            young Nigerian equipped with at least a digital skill.
          </p>

          <button className={styles.growthBtn}>Learn More</button>
        </div>
        <div className={styles.growthImg}>
          <Image src="/images/growth.png" width={500} height={600} alt="Growth" />
        </div>
      </div>
